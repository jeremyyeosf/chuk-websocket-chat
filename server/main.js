...
app.ws('/chat', (ws, req) => {
	...
	ROOM[name] = ws
	// does not return anything, is it because chat.service only accepts payload.data as ChatMessage? 
	ROOM[name].send(`room participants: ', Object.keys(ROOM)`)
	console.log('room participants: ', Object.keys(ROOM))
